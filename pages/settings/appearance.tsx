  ...
  return (
    <MainLayout>
      <div className="w-full">
        ...
        <SettingsLayout>
          <div className="p-4 mb-4 rounded-lg w-fit bg-[#FFE0C4] flex items-center gap-2.5">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            <p className="font-bold text-lg">Appearance Settings</p>
          </div>
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="max-w-[75%] text-black/70">
                  Change the visual appearance of the web app to a dark theme
                </p>
              </div>
